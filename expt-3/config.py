...
# begin of VEP data specification

flags.DEFINE_integer('num_points', 45, 'width of each image in image series.')
flags.DEFINE_integer('num_classes', 2, 'number of classes to classify.')

flags.DEFINE_integer('num_filters', 16, 'number of filters')
flags.DEFINE_integer('sampling_rate', 64, 'sampling rate')
flags.DEFINE_integer('pooling_stride', 2, 'pooling stride')

flags.DEFINE_integer('num_adapt_iterations', 5000, 'number of training iterations.')
...
flags.DEFINE_float('learning_rate', 0.0005, 'the base learning rate of the generator')
flags.DEFINE_float('adp_learning_rate', 0.00002, 'the base learning rate of the generator')
...
# flags.DEFINE_integer('test_size', 1019, 'number of samples for testing')
...
flags.DEFINE_boolean('evaluate', False, 'evaluate using validation data to select model parameters')
